...
#elif defined Q_OS_IOS || (defined Q_OS_MAC && defined TARGET_OS_IPHONE && TARGET_OS_IPHONE) // Q_OS_WINRT || Q_OS_WIN
#include "platform/ios/file_utilities_ios.h"
#elif defined Q_OS_MAC // Q_OS_WINRT || Q_OS_WIN || Q_OS_IOS
#include "platform/mac/file_utilities_mac.h"
#else // Q_OS_WINRT || Q_OS_WIN || Q_OS_MAC || Q_OS_IOS
#include "platform/linux/file_utilities_linux.h"
#endif // else for Q_OS_WINRT || Q_OS_WIN || Q_OS_MAC || Q_OS_IOS
